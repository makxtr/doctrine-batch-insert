...
class IgnoreUpdate implements UpdateStrategyInterface
{
    public function getInsertStatement(PlatformVisitor $platformVisitor): string
    {
        return $platformVisitor->getIgnoreUpdateInsertStatement();
    }
    ...
    public function getPostValuesStatement(
        ...
        return $platformVisitor->getIgnoreUpdatePostValuesStatement(
            $fieldsDTO->getConflictFields()
        );
    }
}
